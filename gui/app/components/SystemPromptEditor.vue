<template>
  <UiCard>
    ...
    <div v-if="!isEditing" class="space-y-3">
      <div 
        class="glass-panel rounded-lg p-4 max-h-64 overflow-y-auto"
      >
    ...
    <div v-else class="space-y-4">
      ...
      <div class="relative">
        <textarea
          ...
          class="w-full h-64 glass-well text-nanna-text text-sm p-4 rounded-lg focus:border-nanna-primary focus:outline-none resize-none font-mono leading-relaxed"
          @input="markChanged"
        />
      ...
      <details class="text-sm">
        ...
        <div class="mt-2 p-3 glass-panel rounded-lg space-y-1 text-xs">
