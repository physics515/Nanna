 ...
 * tool calls; each opens its own text segment (the previous journal item is
 * a tool), and those segments used to render as empty "☽ Nanna" bubbles
 * (observed live 2026-07-30, qwen3.5:9b). An assistant bubble must render
 * only if it has visible text after stripping harness markers.
 */
